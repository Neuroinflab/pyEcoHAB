...
def does_mouse1_push_out(m1_states, m1_times, antennas2, times2):
    ...
    if mice_in_different_spots(m1_states, m2_states):
        # mice in different parts of the system
        return False
...
def check_mouse1_pushing_out_mouse2(antennas1, times1, antennas2,
                                    times2, normalization):
    idx = 0
    dominance_counter = 0
    while True:
    ...
    for i, mouse1 in enumerate(mice):
        ...
        for j, mouse2 in enumerate(mice):
            if i != j:
                ...
                dominance[i, j] = check_mouse1_pushing_out_mouse2(m1_antennas,
                                                                  m1_times,
                                                                  m2_antennas,
                                                                  m2_times,
                                                                  normalization)
