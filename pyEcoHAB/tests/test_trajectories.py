...
class TestAntennaTransitions(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected["ALL"][0.0]["6 6"] = [3.882, .906, 101.777, 17.995, 11.994]
        ...
        cls.expected_dark["1 dark"][0.0]["6 6"] = [3.882, .906, 101.777, 17.995,
                                              11.994]
        ...
        cls.calc =  tr.get_antenna_transitions_durations(cls.data,
                                                         cls.timeline,
                                                         bins="ALL")
        cls.calc_dark = tr.get_antenna_transitions_durations(cls.data,
                                                             cls.timeline,
                                                             bins=1800)
...
class TestGetAntennaTransitions(unittest.TestCase):
    ...
    def test_all_phases(self):
        transitions = tr.get_antenna_transitions_durations(self.data,
                                                           self.timeline,
                                                           bins=30*60)
