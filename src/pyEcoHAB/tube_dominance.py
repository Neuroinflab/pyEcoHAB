...
def get_tube_dominance(ecohab_data, timeline, N, binsize="whole_phase",
    ...
    exec_fun(ecohab_data, timeline, N, var_name="tube_dominance",
             action1_name="pushing",
             action2_name="pushed", data_prep=data_prep,
             function=tube_dominance_matrices, binsize=binsize,
             res_dir=res_dir, prefix=prefix, remove_mouse=remove_mouse,
             save_distributions=save_distributions, save_figures=save_figures,
             return_median=return_median, delimiter=delimiter,
             save_times=save_times, seed=seed, full_dir_tree=full_dir_tree)
